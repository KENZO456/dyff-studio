...
export default function MarketplaceClient({ initialProducts }: { initialProducts: Product[] }) {
  ...
  return (
    <main className="min-h-screen bg-ink-void/60">
      ...
      {/* Fluid CSS Banner moved below hero */}
      <div className="w-full h-24 sm:h-32 md:h-40 relative overflow-hidden border-y border-ink-ash/20">
        <div className="fluid-aurora-banner w-full h-full absolute inset-0 z-0" />
      </div>
